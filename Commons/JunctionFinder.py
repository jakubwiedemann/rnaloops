        ...
        for start in range(len(text)):
            ...
            if bool_found:
                ...
                for connector_id in range(number_of_stems):
                    ...
                    stem_sequence = list_of_connectors[connector_pairs[connector_id][0]].list_of_segment_seq[-1] + '-' + list_of_connectors[connector_pairs[connector_id][1]].list_of_segment_seq[0]
